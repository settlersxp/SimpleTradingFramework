    ...
    if not context.has_table('prop_firms'):
        ...
        op.create_table('prop_firms',
                        ...
                        sa.Column('username', sa.String(length=100),
                                  nullable=True, server_default='default_user'),
                        sa.Column('password', sa.String(length=100),
                                  nullable=True, server_default='default_pass'),
                        sa.Column('ip_address', sa.String(length=100),
                                  nullable=True, server_default='127.0.0.1'),
                        sa.Column('port', sa.Integer(),
                                  nullable=True, server_default='8080'),
                        sa.Column('platform_type', sa.String(
                            length=100), nullable=True, server_default='MT5'),
        ...
        columns_to_add = [
            ...
            ('dowdown_percentage', sa.Float(), False, None)
        ]
...
def downgrade():
    ...
    if context.has_table('prop_firms'):
        ...
        columns_to_drop = ['created_at', 'full_balance',
                           'available_balance', 'dowdown_percentage']
